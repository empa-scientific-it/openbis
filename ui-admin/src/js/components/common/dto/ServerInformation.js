const PERSONAL_ACCESS_TOKENS_ENABLED = 'personal-access-tokens-enabled'
const PERSONAL_ACCESS_TOKENS_MAX_VALIDITY_PERIOD =
  'personal-access-tokens-max-validity-period'
const PERSONAL_ACCESS_TOKENS_VALIDITY_WARNING_PERIOD =
