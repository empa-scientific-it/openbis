...
Plugins are Jython scripts that can accomplish more complex data-checks than ordinary types and vocabularies can achieve. They are assigned to entity types (dataset type, sample type etc). [Documentation and examples can be found here](../../../../../docs-test/docs/user-documentation/general-admin-users/properties-handled-by-scripts.md)
