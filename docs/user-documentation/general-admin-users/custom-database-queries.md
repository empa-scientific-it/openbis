...
[configured](../../../../../docs-test/docs/system-admin-documentation/installation/installation-and-configuration-guide.md#configure-authorization)
...
To use the custom database queries, it is necessary to define query databases. See [Installation and Administrator Guide of the openBIS Server](../../../../../docs-test/docs/system-admin-documentation/installation/installation-and-configuration-guide.md) for an explanation on how to do this.
