...
1.  **no group**. The new *Space* will have no prefix and the Settings
    ...
    Settings](../../../../../../docs-test/docs/user-documentation/general-admin-users/admins-documentation/multi-group-set-up.md#general-eln-settings)).
2.  **in one of the existing groups**. The new *Space* will have the
    ...
    ELN
    Settings](../../../../../../docs-test/docs/user-documentation/general-admin-users/admins-documentation/multi-group-set-up.md#group-eln-settings)).
