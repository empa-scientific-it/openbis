...
See [Use template for Experimental Steps](../../../../../../docs-test/docs/user-documentation/general-users/lab-notebook.md#use-templates-for-experimental-steps) for more info on how to use templates. 
