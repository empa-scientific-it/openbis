...
2.  Define a script that will handle the property
    ...
    -   [Dynamic Properties](../../../../../docs-test/docs/user-documentation/general-admin-users/properties-handled-by-scripts.md#dynamic-properties)
    -   [Managed Properties](../../../../../docs-test/docs/user-documentation/general-admin-users/properties-handled-by-scripts.md#managed-properties)
    -   [Entity validation scripts](../../../../../docs-test/docs/user-documentation/general-admin-users/properties-handled-by-scripts.md#entity-validation-scripts)
...
the basic concept read about [Properties Handled By Scripts](../../../../../docs-test/docs/user-documentation/general-admin-users/properties-handled-by-scripts.md#properties-handled-by-scripts).
...
1.  Validation scripts should be read-only.  
    -   In theory it is possible to edit the entity during the
        ...
        Properties](../../../../../docs-test/docs/user-documentation/general-admin-users/properties-handled-by-scripts.md#dynamic-properties) if you
...
Scripts](../../../../../docs-test/docs/user-documentation/general-admin-users/properties-handled-by-scripts.md#).
...
-   ` IManagedInputWidgetDescriptionFactory inputWidgetFactory()`:
    ...
    and [example](../../../../../docs-test/docs/user-documentation/general-admin-users/properties-handled-by-scripts.md#example-3)).
...
-   ` IElementFactory elementFactory()`: returns a factory that can be
    ...
    properties](../../../../../docs-test/docs/user-documentation/general-admin-users/properties-handled-by-scripts.md#storing-structured-content-in-managed-properties).
...
openBIS entities (see [Linking to openBIS entities](../../../../../docs-test/docs/user-documentation/general-admin-users/properties-handled-by-scripts.md#linking-to-openbis-entities) for more details):
...
example](../../../../../docs-test/docs/user-documentation/general-admin-users/properties-handled-by-scripts.md#example-5)). Otherwise clicking on action
...
[elementFactory()](../../../../../docs-test/docs/user-documentation/general-admin-users/properties-handled-by-scripts.md#predefined-functions).
...
Functions](../../../../../docs-test/docs/user-documentation/general-admin-users/properties-handled-by-scripts.md#predefined-functions).
