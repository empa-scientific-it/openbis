...
service](../../../../../docs-test/docs/user-documentation/legacy-advance-features/openbis-kinme-nodes.md#openbis-aggregation-service-report-reader) report. Only
...
Specifications](../../../../../docs-test/docs/user-documentation/legacy-advance-features/openbis-kinme-nodes.md#knime-aggregation-service-specifications).

### openBIS Aggregated Data File Importer

This nodes allows to invoke an [aggregation
service](../../../../../docs-test/docs/user-documentation/legacy-advance-features/openbis-kinme-nodes.md#knime-aggregation-service-specifications) which returns a name
...
services](../../../../../docs-test/docs/user-documentation/legacy-advance-features/openbis-kinme-nodes.md#knime-aggregation-service-specifications) which follow a
certain protocol. In order to distinguish these services from other
aggregation services the service key (i.e. [core
plugins](../../../../../docs-test/docs/software-developer-documentation/server-side-extensions/core-plugins.md) ID) has to start
