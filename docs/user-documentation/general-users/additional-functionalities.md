...
Registration](../../../../../docs-test/docs/user-documentation/general-admin-users/admins-documentation/new-entity-type-registration.md)).
...
Imports](../../../../../docs-test/docs/software-developer-documentation/legacy-server-side-extensions/custom-import.md)).
