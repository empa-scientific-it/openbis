...
Server](../../../../../docs-test/docs/system-admin-documentation/installation/optional-datastore-server-configuration.md)
...
DSS)](../../../../../docs-test/docs/system-admin-documentation/installation/optional-datastore-server-configuration.md)
...
Transfer to Data
Repositories](../../../../../docs-test/docs/user-documentation/general-admin-users/admins-documentation/enable-transfer-to-data-repositories.md)**.**
