...
manager* in the **ELN Settings** ([Customise Parents and Children Sections in Object Forms)](../../../../../docs-test/docs/user-documentation/general-admin-users/admins-documentation/customise-parents-and-children-sections-in-object-forms.md).
...
Settings**](../../../../../docs-test/docs/user-documentation/general-admin-users/admins-documentation/create-templates-for-objects.md).
...
Please check our documentation for SFTP server configuration: [Installation and Administrators Guide of the openBIS Data Store Server](../../../../../docs-test/docs/system-admin-documentation/installation/optional-datastore-server-configuration.md)
...
capability role
map](../../../../../docs-test/docs/system-admin-documentation/installation/installation-and-configuration-guide.md#changing-the-capability-role-map))
