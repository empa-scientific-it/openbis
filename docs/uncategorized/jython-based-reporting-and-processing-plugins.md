...
|-------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|searchService            |=HYPERLINK("https://openbis.ch/javadoc/20.10.x/javadoc-datastore-server/ch/systemsx/cisd/openbis/dss/generic/shared/api/internal/v2/ISearchService.html","ISearchService")                            |Methods for listing entities from openBIS AS filtered to those visible to the user.                                                                                                                                                                                                |
|searchServiceUnfiltered  |=HYPERLINK("https://openbis.ch/javadoc/20.10.x/javadoc-datastore-server/ch/systemsx/cisd/openbis/dss/generic/shared/api/internal/v2/ISearchService.html","ISearchService")                            |As above, but unfiltered                                                                                                                                                                                                                                                           |
|queryService             |=HYPERLINK("https://openbis.ch/javadoc/20.10.x/javadoc-datastore-server/ch/systemsx/cisd/openbis/dss/generic/shared/api/internal/IDataSourceQueryService.html","IDataSourceQueryService")             |Methods for querying external databases specified in DSS                                                                                                                                                                                                                           |
|mailService              |=HYPERLINK("https://openbis.ch/javadoc/20.10.x/javadoc-datastore-server/ch/systemsx/cisd/openbis/dss/generic/server/plugins/jython/api/IMailService.html","IMailService")                             |Methods for sending emails with an attachment to the user who triggered reporting/processing                                                                                                                                                                                       |
|contentProvider          |=HYPERLINK("https://openbis.ch/javadoc/20.10.x/javadoc-datastore-server/ch/systemsx/cisd/openbis/dss/generic/shared/api/internal/v2/IDataSetContentProvider.html","IDataSetContentProvider")          |=HYPERLINK("https://openbis.ch/javadoc/20.10.x/javadoc-openbis-common/ch/systemsx/cisd/openbis/common/io/hierarchical_content/api/IHierarchicalContent.html","Has a method for retrieving a IHierarchicalContent for a specified data set code, filtered to data visible by user.")|
|contentProviderUnfiltered|=HYPERLINK("https://openbis.ch/javadoc/20.10.x/javadoc-datastore-server/ch/systemsx/cisd/openbis/dss/generic/shared/api/internal/v1/IDataSetContentProvider.html","IDataSetContentProvider")          |=HYPERLINK("https://openbis.ch/javadoc/20.10.x/javadoc-openbis-common/ch/systemsx/cisd/openbis/common/io/hierarchical_content/api/IHierarchicalContent.html","Has a method for retrieving a IHierarchicalContent for a specified data set code, unfiltered.")                      |
|authorizationService     |=HYPERLINK("https://openbis.ch/javadoc/20.10.x/javadoc-datastore-server/ch/systemsx/cisd/openbis/dss/generic/shared/api/internal/v2/authorization/IAuthorizationService.html","IAuthorizationService")|Methods for determining user access privileges and filter entities to those visible to the user.                                                                                                                                                                                   |
