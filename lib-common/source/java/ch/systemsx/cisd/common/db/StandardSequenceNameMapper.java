...
/**
 * Standard sequence name mapper which replaces the last character of the table name by <code>_id_seq</code>. This generic rules applies only for
 * sequence names not found in the map provided as constructor argument.
 * 
