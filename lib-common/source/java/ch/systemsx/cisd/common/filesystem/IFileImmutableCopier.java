...
/**
 * A role which can perform an immutable copy of a file. <i>Immutable</i> here means, that the copied file must not be changed or else the original
 * file may be changed, too. It is, however, safe to delete the file. This restrictions allows to use hard links for performing the copy which can
...
public interface IFileImmutableCopier
{
     ...
     * <code>destinationDirectory/<name></code> must not exist already or else an error is flagged.
     * <p>
     ...
     *            directory.
     * @param nameOrNull The link name in the destination file. If it is <code>null</code>, the name of <var>source</var> will be used instead.
     * @return <code>true</code>, if the source file was copied successfully, <code>false</code> otherwise.
     */
