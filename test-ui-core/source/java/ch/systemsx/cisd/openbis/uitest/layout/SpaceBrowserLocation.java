 ...
 * @author anttil
 */
public class SpaceBrowserLocation implements Location<SpaceBrowser>
{
    ...
    public void moveTo(Pages pages)
    {
        ...
        pages.load(AdminMenu.class).spaces();
    }
    ...
    @Override
    public Class<SpaceBrowser> getPage()
    {
        return SpaceBrowser.class;
    }
}