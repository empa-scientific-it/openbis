 ...
 * @author anttil
 */
public class ListDataSetsOfExperimentsRmi implements Command<List<DataSet>>
{
    @Inject
    ...
    public ListDataSetsOfExperimentsRmi(Experiment first, Experiment... rest)
    {
    ...
    public List<DataSet> execute()
    {
        ...
        List<ch.systemsx.cisd.openbis.generic.shared.api.v1.dto.DataSet> dataSets =
                generalInformationService.listDataSetsForExperiments(session, rmiExperiments,
