 ...
 * @author anttil
 */
public class ListExperimentsHavingSamplesOfProjectsRmi implements Command<List<Experiment>>
{
    ...
    public ListExperimentsHavingSamplesOfProjectsRmi(Project first, Project... rest)
    {
    ...
    public List<Experiment> execute()
    {
        ...
        List<ch.systemsx.cisd.openbis.generic.shared.api.v1.dto.Experiment> experiments =
                generalInformationService.listExperimentsHavingSamples(session, rmiProjectsReduced,
                        null);
