 ...
 * @author anttil
 */
public class AddPropertyTypeLocation implements Location<AddPropertyType>
{
    ...
    public void moveTo(Pages pages)
    {
        ...
        pages.load(AdminMenu.class).newPropertyType();
    }

    @Override
    public String getTabName()
    {
        return "Property Type Registration";
    }

    @Override
    public Class<AddPropertyType> getPage()
    {
        return AddPropertyType.class;
    }
}