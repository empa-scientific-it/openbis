 ...
 * @author anttil
 */
public class ListExperimentsHavingDataSetsOfProjectsRmi implements Command<List<Experiment>>
{
    ...
    public ListExperimentsHavingDataSetsOfProjectsRmi(Project first, Project... rest)
    {
    ...
    public List<Experiment> execute()
    {
        ...
        List<ch.systemsx.cisd.openbis.generic.shared.api.v1.dto.Experiment> experiments =
                generalInformationService.listExperimentsHavingDataSets(session,
                        rmiProjectsReduced,
                        null);
