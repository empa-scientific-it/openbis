...
public class ScriptBrowser extends Browser
{
    ...
    @Locate("openbis_script-browser-grid-paging-toolbar")
    private PagingToolBar paging;

    @Lazy
    @Locate("openbis_script-browser-grid-filter-toolbar")
    private FilterToolBar filters;

    @Lazy
    @Locate("openbis_tab-panelscript-browser-grid")
    private SettingsDialog settings;

    @Locate("openbis_script-browser_add-button")
    private Button add;
