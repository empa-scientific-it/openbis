 ...
 * @author anttil
 */
public class ExperimentTypeBrowserLocation implements Location<ExperimentTypeBrowser>
{
    ...
    public void moveTo(Pages pages)
    {
        ...
        pages.load(AdminMenu.class).experimentTypes();
    }
    ...
    @Override
    public Class<ExperimentTypeBrowser> getPage()
    {
        return ExperimentTypeBrowser.class;
    }
}