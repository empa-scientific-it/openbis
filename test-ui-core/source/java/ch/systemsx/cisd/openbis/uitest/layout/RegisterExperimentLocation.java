 ...
 * @author anttil
 */
public class RegisterExperimentLocation implements Location<RegisterExperiment>
{
    ...
    public void moveTo(Pages pages)
    {
        ...
        pages.load(NewMenu.class).experiment();
    }

    @Override
    public String getTabName()
    {
        return "Experiment Registration";
    }

    @Override
    public Class<RegisterExperiment> getPage()
    {
        return RegisterExperiment.class;
    }
}