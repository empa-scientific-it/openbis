 ...
 * @author anttil
 */
public class GeneralBatchImportLocation implements Location<GeneralBatchImport>
{
    ...
    public void moveTo(Pages pages)
    {
        ...
        pages.load(ImportMenu.class).generalBatchImport();
    }

    @Override
    public Class<GeneralBatchImport> getPage()
    {
        return GeneralBatchImport.class;
    }
}
