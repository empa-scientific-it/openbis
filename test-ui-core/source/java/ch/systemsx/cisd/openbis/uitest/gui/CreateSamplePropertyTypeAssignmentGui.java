 ...
 * @author anttil
 */
public class CreateSamplePropertyTypeAssignmentGui implements Command<PropertyTypeAssignment>
{
    @Inject
    private Pages pages;
    ...
    public CreateSamplePropertyTypeAssignmentGui(PropertyTypeAssignment assignment)
    {
