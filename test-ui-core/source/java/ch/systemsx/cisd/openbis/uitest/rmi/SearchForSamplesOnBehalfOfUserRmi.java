 ...
 * @author anttil
 */
public class SearchForSamplesOnBehalfOfUserRmi implements Command<List<Sample>>
{
    @Inject
    ...
    public SearchForSamplesOnBehalfOfUserRmi(SearchCriteria criteria, User user)
    {
