 ...
 * @author anttil
 */
public class VocabularyBrowserLocation implements Location<VocabularyBrowser>
{
    ...
    public void moveTo(Pages pages)
    {
        ...
        pages.load(AdminMenu.class).vocabularies();
    }

    @Override
    public String getTabName()
    {
        return "Vocabulary Browser";
    }

    @Override
    public Class<VocabularyBrowser> getPage()
    {
        return VocabularyBrowser.class;
    }
}