 ...
 * @author anttil
 */
public class ScriptBrowserLocation implements Location<ScriptBrowser>
{
    ...
    public void moveTo(Pages pages)
    {
        ...
        pages.load(AdminMenu.class).scripts();
    }
    ...
    @Override
    public Class<ScriptBrowser> getPage()
    {
        return ScriptBrowser.class;
    }
}