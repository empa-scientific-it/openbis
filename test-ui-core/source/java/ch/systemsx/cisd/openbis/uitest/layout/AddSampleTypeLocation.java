 ...
 * @author anttil
 */
public class AddSampleTypeLocation implements Location<AddSampleTypeDialog>
{

    @Override
    public void moveTo(Pages pages)
    {
        pages.goTo(new SampleTypeBrowserLocation()).add();
    }
    ...
    @Override
    public Class<AddSampleTypeDialog> getPage()
    {
        return AddSampleTypeDialog.class;
    }
}