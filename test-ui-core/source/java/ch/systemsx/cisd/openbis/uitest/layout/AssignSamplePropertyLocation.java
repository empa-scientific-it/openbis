 ...
 * @author anttil
 */
public class AssignSamplePropertyLocation implements Location<AssignSamplePropertyType>
{
    ...
    public void moveTo(Pages pages)
    {
        ...
        pages.load(AdminMenu.class).assignPropertyTypeToSampleType();
    }

    @Override
    public String getTabName()
    {
        return "Assign Sample Property Type";
    }

    @Override
    public Class<AssignSamplePropertyType> getPage()
    {
        return AssignSamplePropertyType.class;
    }
}