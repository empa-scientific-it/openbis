...
def get_normalized_code(dictionary, row_number, dollar_prefix_allowed=False):
    return get_normalized(dictionary, 'code', row_number, dollar_prefix_allowed)


def get_normalized(dictionary, key, row_number, dollar_prefix_allowed=False):
    value = upper_case_code(dictionary[key]) if key in dictionary else None
