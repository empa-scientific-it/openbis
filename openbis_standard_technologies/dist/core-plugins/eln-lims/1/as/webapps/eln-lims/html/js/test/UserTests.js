     ...
     this.requestForm = function() {
         return new Promise(function executor(resolve, reject) {
             ...
             Promise.resolve().then(() => e.waitForId("STOCK_CATALOG"))
                              ...
                              .then(() => e.searchForObjectInSelect2("PRO17", "add-object-product"))
                              .then(() => e.waitForId("pro17-column-id"))
                              .then(() => e.waitForId("quantity-of-items-pro17"))
                              .then(() => e.change("quantity-of-items-pro17", "18"))
                              .then(() => e.waitForId("save-btn"))
                              .then(() => e.click("save-btn"))
                              .then(() => e.waitForId("edit-btn")) // wait for saving
