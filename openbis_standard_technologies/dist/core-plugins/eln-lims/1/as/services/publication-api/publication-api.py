    ...
    if openBISRelatedIdentifiersString is not None:
        ...
        for identifier in openBISRelatedIdentifiers:
            if (not identifier.startswith('GROUP:')):
                allIdentifiers.append(DataSetPermId(identifier))
        dataSetIdAsList = v3.getDataSets(sessionToken, allIdentifiers, DataSetFetchOptions()).keys()
        for sampleId in sampleIds:
            ...
            dataSetCreation.setComponentIds(dataSetIdAsList)
