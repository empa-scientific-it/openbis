...
public class XLSSampleTypeExportHelper extends AbstractXLSExportHelper
{
            ...
            final XLSExport.TextFormatting textFormatting)
    {
        ...
        if (sampleType != null)
        {
            ...
            warnings.addAll(addRow(wb, rowNumber++, true, ExportableKind.SAMPLE_TYPE, permId, "SAMPLE_TYPE"));
            warnings.addAll(addRow(wb, rowNumber++, true, ExportableKind.SAMPLE_TYPE, permId, "Version", "Code",
            ...
            warnings.addAll(addRow(wb, rowNumber++, false, ExportableKind.SAMPLE_TYPE, permId, "1",
                    sampleType.getCode(),
