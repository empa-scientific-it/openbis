...
class SampleTypeWithChainedDependentSamplesExpectations extends Expectations
{

    public SampleTypeWithChainedDependentSamplesExpectations(final IApplicationServerApi api,
