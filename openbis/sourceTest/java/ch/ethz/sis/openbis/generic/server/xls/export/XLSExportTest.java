...
public class XLSExportTest
{
    ...
    {
        final Workbook actualResult = xlsExport.prepareWorkbook(api, SESSION_TOKEN, Collections.singleton(
                new ExportablePermId(ExportableKind.SAMPLE_TYPE, new EntityTypePermId("ENTRY", EntityKind.SAMPLE))),
                false);

        final InputStream stream = getClass().getClassLoader().getResourceAsStream(
                "ch/ethz/sis/openbis/generic/server/xls/export/resources/export-sample.xlsx");
