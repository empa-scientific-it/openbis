...
class SampleTypeWithDependentSampleExpectations extends Expectations
{

    public SampleTypeWithDependentSampleExpectations(final IApplicationServerApi api, final boolean exportReferred)
    {
        if (exportReferred)
        {
