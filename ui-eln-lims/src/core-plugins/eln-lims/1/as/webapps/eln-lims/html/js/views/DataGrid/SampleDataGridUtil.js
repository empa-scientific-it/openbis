var SampleDataGridUtil = new function() {
    this.getSampleDataGrid = function(mandatoryConfigPostKey, samplesOrCriteria, rowClick, customOperations,
		...
		columnsLast.push({
			...
			exportableProperty: DataGridExportField.space(),
			filterable: true,
			sortable : true
		});
        ...
        if (showParentsAndChildren) {
            columnsLast.push({
                label : 'Parents',
                property : 'parents',
                exportableProperty: DataGridExportField.parents(),
                filterable: true,
                sortable : false,
                truncate: true,
            ...
            columnsLast.push({
                label : 'Children',
                property : 'children',
                exportableProperty: DataGridExportField.children(),
                filterable: true,
                sortable : false,
                truncate: true,
                getValue : function(params) {
            ...
            if(propertyType.dataType === "BOOLEAN"){
                var getBooleanColumn = function(propertyType) {
                    return {
                        ...
                        exportableProperty: DataGridExportField.property(propertyType.code),
                        filterable : true,
                        sortable : false,
                        metadata: {
