...
public class DummyTestCustomServiceWithScript implements ICustomDSSServiceExecutor
{
    private static final String SCRIPT_PATH = "script-path";
    private final String scriptPath;
    public DummyTestCustomServiceWithScript(Properties properties)
    {
            ...
            CustomDSSServiceExecutionOptions options)
    {
        IDssServiceScriptRunner
                runner = new ScriptRunnerFactory(scriptPath, getApplicationServerApi(), getDataStoreServerApi())
