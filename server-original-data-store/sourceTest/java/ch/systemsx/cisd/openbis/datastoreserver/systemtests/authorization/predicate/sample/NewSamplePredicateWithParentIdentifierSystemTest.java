 ...
 * @author pkupczyk
 */
public class NewSamplePredicateWithParentIdentifierSystemTest extends NewSamplePredicateWithSampleSystemTest
{
    ...
    protected NewSample createNonexistentObject(Object param)
    {
        ...
        newSample.setParentsOrNull(new String[] { identifier.toString() });
        return newSample;
    }
