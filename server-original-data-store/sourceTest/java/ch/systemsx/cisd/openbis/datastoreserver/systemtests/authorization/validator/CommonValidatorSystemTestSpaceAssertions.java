 ...
 * @author pkupczyk
 */
public class CommonValidatorSystemTestSpaceAssertions<O> extends CommonValidatorSystemTestAssertionsDelegate<O>
{

    public CommonValidatorSystemTestSpaceAssertions(CommonValidatorSystemTestAssertions<O> delegate)
    {
        super(delegate);
    }
