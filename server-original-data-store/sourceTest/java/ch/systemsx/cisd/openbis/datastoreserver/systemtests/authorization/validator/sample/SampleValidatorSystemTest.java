 ...
 * @author pkupczyk
 */
public class SampleValidatorSystemTest extends CommonValidatorSystemTest<Sample>
{
    ...
    {
        return getBean(SampleValidatorTestService.class).testSampleValidator(user.getSessionProvider(), object);
    }
