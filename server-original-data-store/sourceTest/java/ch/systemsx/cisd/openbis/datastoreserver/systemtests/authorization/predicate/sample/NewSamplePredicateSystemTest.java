 ...
 * @author pkupczyk
 */
public abstract class NewSamplePredicateSystemTest extends CommonPredicateSystemTest<NewSample>
{

    @Override
    protected void evaluateObjects(ProjectAuthorizationUser user, List<NewSample> objects, Object param)
    {
        getBean(SamplePredicateTestService.class).testNewSamplePredicate(user.getSessionProvider(), objects.get(0));
    }
