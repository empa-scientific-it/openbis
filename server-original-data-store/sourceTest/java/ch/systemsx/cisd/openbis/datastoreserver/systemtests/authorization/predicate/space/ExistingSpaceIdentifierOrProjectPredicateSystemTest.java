 ...
 * @author pkupczyk
 */
public class ExistingSpaceIdentifierOrProjectPredicateSystemTest extends CommonPredicateSystemTest<SpaceIdentifier>
{
    ...
    {
        getBean(SpacePredicateTestService.class).testExistingSpaceIdentifierOrProjectPredicate(user.getSessionProvider(), objects.get(0));
    }
        ...
        return new CommonPredicateSystemTestSpaceAssertions<SpaceIdentifier>(super.getAssertions())
            {
                ...
                public void assertWithProject11Object(ProjectAuthorizationUser user, Throwable t, Object param)
                {
                    ...
                    {
                        super.assertWithProject11Object(user, t, param);
                    }
                }
                ...
                public void assertWithProject21Object(ProjectAuthorizationUser user, Throwable t, Object param)
                {
                    ...
                    {
                        super.assertWithProject21Object(user, t, param);
                    }
                }
            };
    }
