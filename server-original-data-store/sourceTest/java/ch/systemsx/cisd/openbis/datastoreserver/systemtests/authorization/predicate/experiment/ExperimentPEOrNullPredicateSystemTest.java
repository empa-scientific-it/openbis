 ...
 * @author pkupczyk
 */
public class ExperimentPEOrNullPredicateSystemTest extends CommonPredicateSystemTest<ExperimentPE>
{
    ...
    {
        getBean(ExperimentPredicateTestService.class).testExperimentPEOrNullPredicate(user.getSessionProvider(), objects.get(0));
    }
