 ...
 * @author pkupczyk
 */
public class NewSamplePredicateWithProjectIdentifierSystemTest extends NewSamplePredicateSystemTest
{
    ...
    protected NewSample createNonexistentObject(Object param)
    {
        ...
        newSample.setProjectIdentifier("/IDONTEXIST/IDONTEXIST");
        return newSample;
    }
    ...
    {
        NewSample newSample = new NewSample();
        newSample.setProjectIdentifier("/" + spacePE.getCode() + "/" + projectPE.getCode());
        return newSample;
    }
