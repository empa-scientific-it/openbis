 ...
 * @author pkupczyk
 */
public class CommonValidatorSystemTestDataSetAssertions<O> extends CommonValidatorSystemTestAssertionsDelegate<O>
{

    public CommonValidatorSystemTestDataSetAssertions(CommonValidatorSystemTestAssertions<O> delegate)
    {
        super(delegate);
    }
