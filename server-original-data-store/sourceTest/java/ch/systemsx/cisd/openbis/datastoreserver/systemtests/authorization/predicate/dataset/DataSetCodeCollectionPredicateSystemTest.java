 ...
 * @author pkupczyk
 */
public class DataSetCodeCollectionPredicateSystemTest extends CommonPredicateSystemTest<String>
{
    ...
    {
        getBean(DataSetPredicateTestService.class).testDataSetCodeCollectionPredicate(user.getSessionProvider(), objects);
    }
