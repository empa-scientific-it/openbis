 ...
 * @author pkupczyk
 */
public class CommonPredicateSystemTestDataSetAssertions<O> extends CommonPredicateSystemTestAssertionsDelegate<O>
{

    public CommonPredicateSystemTestDataSetAssertions(CommonPredicateSystemTestAssertions<O> delegate)
    {
        super(delegate);
    }
