 ...
 * @author pkupczyk
 */
public class SampleTechIdCollectionReadWritePredicateSystemTest extends SampleTechIdCollectionPredicateSystemTest
{
    ...
    {
        getBean(SamplePredicateTestService.class).testSampleTechIdCollectionReadWritePredicate(user.getSessionProvider(), objects);
    }
