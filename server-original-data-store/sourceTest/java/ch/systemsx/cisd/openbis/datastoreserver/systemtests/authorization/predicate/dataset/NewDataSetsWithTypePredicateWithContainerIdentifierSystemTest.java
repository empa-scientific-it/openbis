 ...
 * @author pkupczyk
 */
public class NewDataSetsWithTypePredicateWithContainerIdentifierSystemTest extends NewDataSetsWithTypePredicateSystemTest<String>
{
    ...
    protected void evaluateObjects(ProjectAuthorizationUser user, List<String> objects, Object param)
    {
        evaluateObjects(user, objects, param, new NewDataSetField<String>()
            {
                @Override
                public void set(NewDataSet dataSet, String containerCode)
                {
                    dataSet.setContainerIdentifierOrNull(containerCode);
                }
            });
    }
