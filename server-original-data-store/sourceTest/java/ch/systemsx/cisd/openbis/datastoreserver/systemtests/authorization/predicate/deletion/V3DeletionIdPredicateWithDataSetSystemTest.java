 ...
 * @author pkupczyk
 */
public class V3DeletionIdPredicateWithDataSetSystemTest extends V3DeletionIdPredicateSystemTest
{
    ...
    {
        return new CommonPredicateSystemTestDataSetAssertions<IDeletionId>(super.getAssertions());
    }
