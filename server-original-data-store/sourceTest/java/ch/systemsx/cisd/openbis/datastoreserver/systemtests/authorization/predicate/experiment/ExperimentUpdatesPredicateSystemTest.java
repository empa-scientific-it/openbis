 ...
 * @author pkupczyk
 */
public abstract class ExperimentUpdatesPredicateSystemTest extends CommonPredicateSystemTest<ExperimentUpdatesDTO>
{

    @Override
    protected void evaluateObjects(ProjectAuthorizationUser user, List<ExperimentUpdatesDTO> objects, Object param)
    {
        getBean(ExperimentPredicateTestService.class).testExperimentUpdatesPredicate(user.getSessionProvider(), objects.get(0));
    }
