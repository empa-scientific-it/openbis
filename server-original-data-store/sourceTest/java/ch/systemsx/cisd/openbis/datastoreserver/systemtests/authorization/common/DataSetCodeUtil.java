...
public class DataSetCodeUtil
{
    ...
    public static String createNonexistentObject(Object param)
    {
        return "IDONTEXIST";
    }

    public static String createObject(CommonAuthorizationSystemTest test, SpacePE spacePE, ProjectPE projectPE, Object param)
    {
        DataPE dataSetPE = test.getDataSet(spacePE, projectPE, (DataSetKind) param);
        return dataSetPE.getCode();
    }
