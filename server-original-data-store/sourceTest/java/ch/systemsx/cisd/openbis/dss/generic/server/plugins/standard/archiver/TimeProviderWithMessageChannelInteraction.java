...
final class TimeProviderWithMessageChannelInteraction implements ITimeAndWaitingProvider
{
            ...
            int numberOfPolls)
    {
        ...
        this.testrunnerChannel = testrunnerChannel;
    ...
    {
        return mockTimeProvider.getTimeInMilliseconds();
    }

    @Override
    public void sleep(long milliseconds)
    {
        mockTimeProvider.sleep(milliseconds);
        numberOfPolls--;
        if (deleter != null && numberOfPolls == 0)
        {
            deleter.stop();
        }
