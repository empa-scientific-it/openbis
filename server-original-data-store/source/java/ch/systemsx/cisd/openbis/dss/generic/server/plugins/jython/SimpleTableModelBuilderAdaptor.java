 ...
 * <p>
 * The intent of the interface and adaptor is not to expose {@link SimpleTableModelBuilder} interface in the API and optionally add convenience
 * methods for scripts.
 * 
 * @author Piotr Buczek
 */
class SimpleTableModelBuilderAdaptor implements ISimpleTableModelBuilderAdaptor
{
    ...
    {
        // TODO entityInformationProvider.getIdentifier(entityLink);
        return null;
    }
}
