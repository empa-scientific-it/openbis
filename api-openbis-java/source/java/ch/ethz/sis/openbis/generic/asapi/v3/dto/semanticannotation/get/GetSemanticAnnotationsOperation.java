...
public class GetSemanticAnnotationsOperation extends GetObjectsOperation<ISemanticAnnotationId, SemanticAnnotationFetchOptions>
{
    private static final long serialVersionUID = 1L;

    @SuppressWarnings("unused")
    private GetSemanticAnnotationsOperation()
    {
    }
