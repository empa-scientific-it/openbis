...
public class GetRoleAssignmentsOperationResult extends GetObjectsOperationResult<IRoleAssignmentId, RoleAssignment>
{

    private static final long serialVersionUID = 1L;

    @SuppressWarnings("unused")
    private GetRoleAssignmentsOperationResult()
    {
    }

    public GetRoleAssignmentsOperationResult(Map<IRoleAssignmentId, RoleAssignment> objectMap)
    {
        super(objectMap);
    }
}
