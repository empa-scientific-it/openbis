...
public class CreateAuthorizationGroupsOperation extends CreateObjectsOperation<AuthorizationGroupCreation>
{
    ...
    private CreateAuthorizationGroupsOperation()
    {
    }

    public CreateAuthorizationGroupsOperation(AuthorizationGroupCreation... creations)
    {
        super(creations);
    }

    public CreateAuthorizationGroupsOperation(List<AuthorizationGroupCreation> creations)
    {
        super(creations);
    }
