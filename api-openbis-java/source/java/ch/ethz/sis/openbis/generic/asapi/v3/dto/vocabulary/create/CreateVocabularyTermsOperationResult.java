 ...
 * @author pkupczyk
 */
@JsonObject("as.dto.vocabulary.create.CreateVocabularyTermsOperationResult")
public class CreateVocabularyTermsOperationResult extends CreateObjectsOperationResult<VocabularyTermPermId>
{

    private static final long serialVersionUID = 1L;

    @SuppressWarnings("unused")
    private CreateVocabularyTermsOperationResult()
    {
    }
