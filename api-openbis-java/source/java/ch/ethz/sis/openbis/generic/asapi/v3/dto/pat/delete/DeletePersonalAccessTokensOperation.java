 ...
 * @author pkupczyk
 */
@JsonObject("as.dto.pat.delete.DeletePersonalAccessTokensOperation")
public class DeletePersonalAccessTokensOperation extends DeleteObjectsOperation<IPersonalAccessTokenId, PersonalAccessTokenDeletionOptions>
{
    private static final long serialVersionUID = 1L;

    @SuppressWarnings("unused")
    private DeletePersonalAccessTokensOperation()
    {
    }

    public DeletePersonalAccessTokensOperation(List<? extends IPersonalAccessTokenId> objectIds, PersonalAccessTokenDeletionOptions options)
    {
