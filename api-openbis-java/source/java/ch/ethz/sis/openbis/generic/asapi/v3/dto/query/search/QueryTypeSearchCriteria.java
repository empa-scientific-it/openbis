 ...
 * @author pkupczyk
 */
@JsonObject("as.dto.query.search.QueryTypeSearchCriteria")
public class QueryTypeSearchCriteria extends EnumFieldSearchCriteria<QueryType>
{

    private static final long serialVersionUID = 1L;

    public QueryTypeSearchCriteria()
    {
        super("queryType", SearchFieldType.ATTRIBUTE);
    }
