...
public class EventFetchOptions extends FetchOptions<Event> implements Serializable
{
    ...
    // Method automatically generated with DtoGenerator
    @Override
    public EventSortOptions sortBy()
    {
        if (sort == null)
        {
            sort = new EventSortOptions();
        }
        return sort;
    }
    ...
    // Method automatically generated with DtoGenerator
    @Override
    public EventSortOptions getSortBy()
    {
        return sort;
    }
    @Override
