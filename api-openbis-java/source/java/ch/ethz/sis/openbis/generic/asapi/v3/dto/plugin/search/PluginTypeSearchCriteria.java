 ...
 *
 */
@JsonObject("as.dto.plugin.search.PluginTypeSearchCriteria")
public class PluginTypeSearchCriteria extends EnumFieldSearchCriteria<PluginType>
{
    private static final long serialVersionUID = 1L;

    public PluginTypeSearchCriteria()
    {
        super("plugin type", SearchFieldType.ATTRIBUTE);
    }
