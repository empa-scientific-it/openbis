...
public class DeleteSemanticAnnotationsOperation extends DeleteObjectsOperation<ISemanticAnnotationId, SemanticAnnotationDeletionOptions>
{
    private static final long serialVersionUID = 1L;

    @SuppressWarnings("unused")
    private DeleteSemanticAnnotationsOperation()
    {
    }
