 ...
 * @author pkupczyk
 */
@JsonObject("as.dto.dataset.search.CompleteSearchCriteria")
public class CompleteSearchCriteria extends EnumFieldSearchCriteria<Complete>
{

    private static final long serialVersionUID = 1L;

    public CompleteSearchCriteria()
    {
        super("complete", SearchFieldType.ATTRIBUTE);
    }
