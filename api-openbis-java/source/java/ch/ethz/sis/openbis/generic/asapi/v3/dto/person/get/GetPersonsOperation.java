...
public class GetPersonsOperation extends GetObjectsOperation<IPersonId, PersonFetchOptions>
{

    private static final long serialVersionUID = 1L;
    
    @SuppressWarnings("unused")
    private GetPersonsOperation()
    {
    }

    public GetPersonsOperation(List<? extends IPersonId> ids, PersonFetchOptions fetchOptions)
    {
