...
@JsonObject("as.dto.common.search.AnyStringPropertySearchCriteria")
public class AnyStringPropertySearchCriteria extends StringFieldSearchCriteria
{

    private static final long serialVersionUID = 1L;

    protected AnyStringPropertySearchCriteria()
    {
