 ...
 * @author anttil
 */
@JsonObject("as.dto.externaldms.search.ExternalDmsTypeSearchCriteria")
public class ExternalDmsTypeSearchCriteria extends EnumFieldSearchCriteria<ExternalDmsAddressType>
{
    ...
    {
        super("type", SearchFieldType.ATTRIBUTE);
    }
