...
public class CreateProjectsOperationResult extends CreateObjectsOperationResult<ProjectPermId>
{

    private static final long serialVersionUID = 1L;

    @SuppressWarnings("unused")
    private CreateProjectsOperationResult()
    {
    }

    public CreateProjectsOperationResult(List<ProjectPermId> objectIds)
    {
        super(objectIds);
    }
}
