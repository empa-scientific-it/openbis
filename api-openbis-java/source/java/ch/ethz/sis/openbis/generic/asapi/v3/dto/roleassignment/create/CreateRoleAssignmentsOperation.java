...
public class CreateRoleAssignmentsOperation extends CreateObjectsOperation<RoleAssignmentCreation>
{
    ...
    private CreateRoleAssignmentsOperation()
    {
    }

    public CreateRoleAssignmentsOperation(RoleAssignmentCreation... creations)
    {
        super(creations);
    }

    public CreateRoleAssignmentsOperation(List<RoleAssignmentCreation> creations)
    {
        super(creations);
    }
