...
public class GetTagsOperation extends GetObjectsOperation<ITagId, TagFetchOptions>
{
    private static final long serialVersionUID = 1L;

    @SuppressWarnings("unused")
    private GetTagsOperation()
    {
    }

    public GetTagsOperation(List<? extends ITagId> ids, TagFetchOptions fetchOptions)
    {
