...
public class UpdateSemanticAnnotationsOperationResult extends UpdateObjectsOperationResult<SemanticAnnotationPermId>
{

    private static final long serialVersionUID = 1L;

    @SuppressWarnings("unused")
    private UpdateSemanticAnnotationsOperationResult()
    {
    }

    public UpdateSemanticAnnotationsOperationResult(List<SemanticAnnotationPermId> ids)
    {
        super(ids);
    }
