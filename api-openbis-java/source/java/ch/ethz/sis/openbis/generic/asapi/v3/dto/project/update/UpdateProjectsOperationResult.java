 ...
 * @author pkupczyk
 */
@JsonObject("as.dto.project.update.UpdateProjectsOperationResult")
public class UpdateProjectsOperationResult extends UpdateObjectsOperationResult<ProjectPermId>
{
