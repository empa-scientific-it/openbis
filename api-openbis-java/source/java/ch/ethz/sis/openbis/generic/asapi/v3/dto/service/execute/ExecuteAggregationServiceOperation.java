...
public class ExecuteAggregationServiceOperation implements IOperation
{
    private static final long serialVersionUID = 1L;

    private IDssServiceId serviceId;

    private AggregationServiceExecutionOptions options;

    @SuppressWarnings("unused")
    private ExecuteAggregationServiceOperation()
    {
    }
    ...
    public AggregationServiceExecutionOptions getOptions()
    {
        return options;
    }
