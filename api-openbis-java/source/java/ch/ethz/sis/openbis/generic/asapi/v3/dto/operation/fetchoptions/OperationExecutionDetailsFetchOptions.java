 ...
 */
@JsonObject("as.dto.operation.fetchoptions.OperationExecutionDetailsFetchOptions")
public class OperationExecutionDetailsFetchOptions extends FetchOptions<OperationExecutionDetails> implements Serializable
{
    ...
    @JsonProperty
    private OperationExecutionDetailsSortOptions sort;
    ...
    // Method automatically generated with DtoGenerator
    @Override
    public OperationExecutionDetailsSortOptions sortBy()
    {
        if (sort == null)
        {
            sort = new OperationExecutionDetailsSortOptions();
        }
        return sort;
    }
    ...
    // Method automatically generated with DtoGenerator
    @Override
    public OperationExecutionDetailsSortOptions getSortBy()
    {
        return sort;
    }
    @Override
    ...
    {
        FetchOptionsToStringBuilder f = new FetchOptionsToStringBuilder("OperationExecutionDetails", this);
