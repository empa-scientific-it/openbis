...
public class DeleteOperationExecutionsOperation extends DeleteObjectsOperation<IOperationExecutionId, OperationExecutionDeletionOptions>
{
    private static final long serialVersionUID = 1L;

    @SuppressWarnings("unused")
    private DeleteOperationExecutionsOperation()
    {
    }
