 ...
 */
class DataSetRelationshipsHistory extends AbstractRelationshipsHistory
{
    ...
    public void setMainDataId(Long mainSampId)
    {
        this.mainDataId = mainSampId;
    }
