...
/**
 * Abstract super class of builds of {@link EntityTypePE} instances.
 *
 * @author felmer
 */
abstract class AbstractEntityTypePEBuilder
{
    public EntityTypePropertyTypePEBuilder assign(String propertyTypeCode)
    {
