 ...
 * @author pkupczyk
 */
public class ProjectAuthorizationDisabled<O> implements IProjectAuthorization<O>
{

    private IObjectsProvider<O> objectsProvider;

    ProjectAuthorizationDisabled(IObjectsProvider<O> objectsProvider)
    {
    ...
    {
        return objectsProvider.getOriginalObjects();
    }
