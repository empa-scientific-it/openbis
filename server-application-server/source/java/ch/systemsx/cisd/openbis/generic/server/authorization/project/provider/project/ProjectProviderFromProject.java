 ...
 * @author pkupczyk
 */
public class ProjectProviderFromProject extends SingleObjectProvider<Project>
{

    public ProjectProviderFromProject(Project project)
    {
        super(project);
    }
    ...
    {
        return new ProjectFromProject(project);
    }
