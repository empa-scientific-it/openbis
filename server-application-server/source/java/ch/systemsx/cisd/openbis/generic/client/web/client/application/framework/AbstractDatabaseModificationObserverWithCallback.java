 ...
 * @author Piotr Buczek
 */
public abstract class AbstractDatabaseModificationObserverWithCallback implements
        IDatabaseModificationObserverWithCallback
{
    ...
    protected void executeSuccessfulUpdateCallback()
    {
        action.execute();
    }
