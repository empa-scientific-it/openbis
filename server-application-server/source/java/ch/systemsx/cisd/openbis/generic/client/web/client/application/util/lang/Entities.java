 ...
 * </p>
 * <p>
 * This is an implementation taken from org.apache.commons.lang with java.io dependencies removed.
 * </p>
 * <p>
 * To update this to a new version of apache.commons.lang add an inner {@link StringWriter} class to the class code and remove throws IOException
 * declaration everywhere. To remove warnings add {@link SuppressWarnings} annotation on the class and some {@link Override} annotations on a few
 * methods. {@link IntHashMap} is copied without changes.
 * </p>
 * 
 * @author Piotr Buczek
 */
class Entities
{
    ...
    /**
     * <p>
     * Escapes the characters in the <code>String</code> passed and writes the result to the <code>StringWriter</code> passed.
     * </p>
     * 
     * @param writer The <code>StringWriter</code> to write the results of the escaping to. Assumed to be a non-null value.
     ...
     */
    private void doUnescape(StringWriter writer, String str, int firstAmp)
    {
    ...
    /** A simplified implementation of java.io.StringWriter based on {@link StringBuilder}. */
    final static class StringWriter
    {
