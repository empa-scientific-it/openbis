...
public class CustomColumnJSONBuilder
{
    ...
    public static String build(CustomColumnJSONServerData data)
    {
        if (data == null)
        {
        ...
        try
        {
            ...
            map.put(CustomColumnParam.$$__METHOD__$$.name(), data.getMethod());
            map.put(CustomColumnParam.$$__PARAMS__$$.name(), data.getParams());
