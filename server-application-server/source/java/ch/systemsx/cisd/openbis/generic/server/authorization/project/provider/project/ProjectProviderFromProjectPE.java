 ...
 * @author pkupczyk
 */
public class ProjectProviderFromProjectPE extends SingleObjectProvider<ProjectPE>
{

    public ProjectProviderFromProjectPE(ProjectPE projectPE)
    {
        super(projectPE);
    }

    @Override
    protected IProject createProject(IAuthorizationDataProvider dataProvider, ProjectPE projectPE)
    {
