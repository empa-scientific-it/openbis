...
/**
 * Validator based on an experiment identifier.
 * 
 * @author Franz-Josef Elmer
 */
public class ExperimentByIdentiferValidator extends AbstractIdentifierValidator
{
    @Override
    ...
    public boolean doValidation(PersonPE person, IIdentifierHolder value)
    {
        ...
        {
            return isValidPA(person, new ProjectProviderFromExperimentIIdentifierHolder(value));
        }
    }
