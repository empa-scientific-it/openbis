...
/**
 * An interface that contains all data access operations on {@link CorePluginPE}s.
 * 
 * @author Kaloyan Enimanev
 */
public interface ICorePluginDAO
{
    /**
    ...
    /**
     * Return all records for a specified plugin name.
     */
