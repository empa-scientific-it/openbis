 ...
 * @author pkupczyk
 */
public class ProjectProviderFromNewExperiment extends SingleObjectProvider<NewExperiment>
{

    public ProjectProviderFromNewExperiment(NewExperiment newExperiment)
    {
        super(newExperiment);
    }

    @Override
    protected IProject createProject(IAuthorizationDataProvider dataProvider, NewExperiment newExperiment)
    {
        if (newExperiment.getIdentifier() != null)
        {
            ExperimentIdentifier experimentIdentifier = ExperimentIdentifierFactory.parse(newExperiment.getIdentifier());
