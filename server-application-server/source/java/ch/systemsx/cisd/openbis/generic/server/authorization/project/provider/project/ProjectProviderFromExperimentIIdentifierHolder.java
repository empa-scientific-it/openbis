 ...
 * @author pkupczyk
 */
public class ProjectProviderFromExperimentIIdentifierHolder extends SingleObjectProvider<IIdentifierHolder>
{

    public ProjectProviderFromExperimentIIdentifierHolder(IIdentifierHolder experimentIdentifierHolder)
    {
        super(experimentIdentifierHolder);
    }

    @Override
    protected IProject createProject(IAuthorizationDataProvider dataProvider, IIdentifierHolder experimentIdentifierHolder)
    {
        ExperimentIdentifier experimentIdentifier = ExperimentIdentifierFactory.parse(experimentIdentifierHolder.getIdentifier());
