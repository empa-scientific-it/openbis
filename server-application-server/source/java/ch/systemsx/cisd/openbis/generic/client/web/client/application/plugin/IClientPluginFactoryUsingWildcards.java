...
/**
 * An extension of the @{link IClientPluginFactory} that supports using regular expression wildcards in the codes.
 * 
 * @author Chandrasekhar Ramakrishnan
 */
public interface IClientPluginFactoryUsingWildcards extends IClientPluginFactory
{
    /**
