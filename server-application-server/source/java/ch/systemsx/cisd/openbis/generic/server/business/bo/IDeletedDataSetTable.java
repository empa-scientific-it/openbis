...
/**
 * A <i>Business Object</i> to handle {@link DeletedDataPE}-s.
 * 
 * @author Piotr Buczek
 */
public interface IDeletedDataSetTable
{
    /**
     * Permanently Deletes loaded data sets for specified reason.
     */
    void permanentlyDeleteLoadedDataSets(String reason, boolean forceDisallowedTypes);
