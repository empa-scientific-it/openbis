...
import ch.ethz.sis.openbis.generic.asapi.v3.dto.vocabulary.delete.DeleteVocabularyTermsOperationResult;
 ...
 */
@Component
public class DeleteVocabularyTermsOperationExecutor extends DeleteObjectsOperationExecutor<IVocabularyTermId, VocabularyTermDeletionOptions>
        implements IDeleteVocabularyTermsOperationExecutor
{

    @Autowired
    private IDeleteVocabularyTermExecutor executor;

    @Override
    protected Class<? extends DeleteObjectsOperation<IVocabularyTermId, VocabularyTermDeletionOptions>> getOperationClass()
    {
        return DeleteVocabularyTermsOperation.class;
    }

    @Override
    protected DeleteObjectsOperationResult doExecute(IOperationContext context,
            DeleteObjectsOperation<IVocabularyTermId, VocabularyTermDeletionOptions> operation)
    {
        executor.delete(context, operation.getObjectIds(), operation.getOptions());
        return new DeleteVocabularyTermsOperationResult();
    }
