 ...
 */
@Component
public class CreateSemanticAnnotationsOperationExecutor extends CreateObjectsOperationExecutor<SemanticAnnotationCreation, SemanticAnnotationPermId>
        implements ICreateSemanticAnnotationsOperationExecutor
{

    @Autowired
    private ICreateSemanticAnnotationExecutor executor;

    @Override
    protected Class<? extends CreateObjectsOperation<SemanticAnnotationCreation>> getOperationClass()
    {
        return CreateSemanticAnnotationsOperation.class;
    }

    @Override
    protected CreateObjectsOperationResult<SemanticAnnotationPermId> doExecute(IOperationContext context,
            CreateObjectsOperation<SemanticAnnotationCreation> operation)
    {
        return new CreateSemanticAnnotationsOperationResult(executor.create(context, operation.getCreations()));
    }
