...
import ch.ethz.sis.openbis.generic.server.asapi.v3.helper.roleassignment.ListRoleAssignmentTechIdByTechId;
 ...
 */
@Component
public class MapRoleAssignmentTechIdByIdExecutor extends AbstractMapObjectByIdExecutor<IRoleAssignmentId, Long>  implements IMapRoleAssignmentTechIdByIdExecutor
{
    @Autowired
    ...
    @Override
    protected void addListers(IOperationContext context, List<IListObjectById<? extends IRoleAssignmentId, Long>> listers)
    {
        listers.add(new ListRoleAssignmentTechIdByTechId());
