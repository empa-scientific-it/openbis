 ...
 *
 */
public interface IExecuteReportingServiceExecutor
{

    TableModel execute(IOperationContext context, IDssServiceId serviceId, ReportingServiceExecutionOptions options);
