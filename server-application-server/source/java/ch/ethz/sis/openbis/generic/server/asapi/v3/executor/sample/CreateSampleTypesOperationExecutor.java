 ...
 */
@Component
public class CreateSampleTypesOperationExecutor extends CreateObjectsOperationExecutor<SampleTypeCreation, EntityTypePermId> implements
        ICreateSampleTypesOperationExecutor
{

    @Autowired
    private ICreateSampleTypeExecutor executor;

    @Override
    protected Class<? extends CreateObjectsOperation<SampleTypeCreation>> getOperationClass()
    {
        return CreateSampleTypesOperation.class;
    }

    @Override
    protected CreateObjectsOperationResult<EntityTypePermId> doExecute(IOperationContext context,
            CreateObjectsOperation<SampleTypeCreation> operation)
    {
        return new CreateSampleTypesOperationResult(executor.create(context, operation.getCreations()));
    }
