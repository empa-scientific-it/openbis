 ...
 */
@Component
public class ReportingServiceAuthorizationExecutor implements IReportingServiceAuthorizationExecutor
{

    @Override
    @RolesAllowed({ RoleWithHierarchy.PROJECT_OBSERVER })
    @Capability("SEARCH_REPORTING_SERVICES")
    ...
    @Override
    @RolesAllowed({ RoleWithHierarchy.PROJECT_OBSERVER })
    @Capability("EXECUTE_REPORTING_SERVICES")
