 ...
 */
@Component
public class CreateQueriesOperationExecutor extends CreateObjectsOperationExecutor<QueryCreation, QueryTechId> implements
        ICreateQueriesOperationExecutor
{

    @Autowired
    private ICreateQueryExecutor executor;

    @Override
    protected Class<? extends CreateObjectsOperation<QueryCreation>> getOperationClass()
    {
        return CreateQueriesOperation.class;
    }

    @Override
    protected CreateObjectsOperationResult<QueryTechId> doExecute(IOperationContext context, CreateObjectsOperation<QueryCreation> operation)
    {
        return new CreateQueriesOperationResult(executor.create(context, operation.getCreations()));
    }
