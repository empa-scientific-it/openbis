 ...
 */
@Component
public class ExternalDmsAuthorizationExecutor implements IExternalDmsAuthorizationExecutor
{
    ...
    @Capability("CREATE_EXTERNAL_DMS")
    ...
    @Override
    @RolesAllowed({ RoleWithHierarchy.INSTANCE_ADMIN })
    @Capability("DELETE_EXTERNAL_DMS")
    ...
    @Override
    @RolesAllowed({ RoleWithHierarchy.PROJECT_OBSERVER, RoleWithHierarchy.SPACE_ETL_SERVER })
    @Capability("SEARCH_EXTERNAL_DMS")
    ...
    @Override
    @RolesAllowed({ RoleWithHierarchy.INSTANCE_ADMIN })
    @Capability("UPDATE_EXTERNAL_DMS")
