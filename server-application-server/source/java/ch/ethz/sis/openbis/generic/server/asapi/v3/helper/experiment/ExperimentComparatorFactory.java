 ...
 * @author pkupczyk
 */
public class ExperimentComparatorFactory extends EntityWithPropertiesComparatorFactory<Experiment>
{

    @Override
    public boolean accepts(Class<?> sortOptionsClass)
    {
        return ExperimentSortOptions.class.equals(sortOptionsClass);
    }
