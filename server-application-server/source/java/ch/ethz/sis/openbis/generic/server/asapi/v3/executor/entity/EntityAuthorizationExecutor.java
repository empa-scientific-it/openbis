 ...
 */
@Component
public class EntityAuthorizationExecutor implements IEntityAuthorizationExecutor
{

    @Override
    @RolesAllowed({ RoleWithHierarchy.PROJECT_USER, RoleWithHierarchy.SPACE_ETL_SERVER })
    @Capability("CREATE_CODES")
    public void canCreateCodes(IOperationContext context)
    {
    }
