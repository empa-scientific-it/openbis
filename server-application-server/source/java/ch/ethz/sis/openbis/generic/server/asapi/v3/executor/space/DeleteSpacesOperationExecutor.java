 ...
 */
@Component
public class DeleteSpacesOperationExecutor extends DeleteObjectsOperationExecutor<ISpaceId, SpaceDeletionOptions> implements
        IDeleteSpacesOperationExecutor
{

    @Autowired
    private IDeleteSpaceExecutor executor;

    @Override
    protected Class<? extends DeleteObjectsOperation<ISpaceId, SpaceDeletionOptions>> getOperationClass()
    {
        return DeleteSpacesOperation.class;
    }

    @Override
    protected DeleteObjectsOperationResult doExecute(IOperationContext context, DeleteObjectsOperation<ISpaceId, SpaceDeletionOptions> operation)
    {
