...
import ch.ethz.sis.openbis.generic.asapi.v3.dto.query.delete.DeleteQueriesOperationResult;
 ...
 */
@Component
public class DeleteQueriesOperationExecutor extends DeleteObjectsOperationExecutor<IQueryId, QueryDeletionOptions> implements
        IDeleteQueriesOperationExecutor
{

    @Autowired
    private IDeleteQueryExecutor executor;

    @Override
    protected Class<? extends DeleteObjectsOperation<IQueryId, QueryDeletionOptions>> getOperationClass()
    {
        return DeleteQueriesOperation.class;
    }

    @Override
    protected DeleteObjectsOperationResult doExecute(IOperationContext context, DeleteObjectsOperation<IQueryId, QueryDeletionOptions> operation)
    {
        executor.delete(context, operation.getObjectIds(), operation.getOptions());
        return new DeleteQueriesOperationResult();
    }
