 ...
 */
@Component
public class SemanticAnnotationPropertyTypeTranslator extends ObjectToOneRelationTranslator<PropertyType, PropertyTypeFetchOptions>
        implements ISemanticAnnotationPropertyTypeTranslator
{
    ...
    protected List<ObjectRelationRecord> loadRecords(LongOpenHashSet annotationIds)
    {
        ...
        return query.getPropertyTypeIds(new LongOpenHashSet(annotationIds));
    }

    @Override
    protected Map<Long, PropertyType> translateRelated(TranslationContext context, Collection<Long> relatedIds,
            PropertyTypeFetchOptions relatedFetchOptions)
    {
        return propertyTypeTranslator.translate(context, relatedIds, relatedFetchOptions);
    }
