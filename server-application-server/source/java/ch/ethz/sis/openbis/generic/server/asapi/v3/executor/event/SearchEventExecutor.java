 ...
 */
@Component
public class SearchEventExecutor implements ISearchEventExecutor
{

    @Override
    public List<EventPE> search(IOperationContext context, EventSearchCriteria criteria, EventFetchOptions fetchOptions)
    {
        return null;
    }
