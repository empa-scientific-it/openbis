 ...
 */
@Component
public class PropertyTypeMaterialTypeTranslator extends ObjectToOneRelationTranslator<MaterialType, MaterialTypeFetchOptions> implements
        IPropertyTypeMaterialTypeTranslator
{
    ...
    protected List<ObjectRelationRecord> loadRecords(LongOpenHashSet objectIds)
    {
        ...
        return query.getMaterialTypeIds(objectIds);
    }
    ...
    {
        return materialTypeTranslator.translate(context, relatedIds, relatedFetchOptions);
    }
