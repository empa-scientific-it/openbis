...
{
    @Select(sql = "select id, perm_id as identifier from semantic_annotations where perm_id = any(?{1})", parameterBindings = {
            StringArrayMapper.class }, fetchSize = FETCH_SIZE)
    public List<TechIdStringIdentifierRecord> listSemanticAnnotationTechIdsByPermIds(String[] permIds);
