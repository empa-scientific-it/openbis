...
import ch.ethz.sis.openbis.generic.server.asapi.v3.translator.property.PropertyTranslator;

/**
 * @author pkupczyk
 */
@Component
public class ExperimentPropertyTranslator extends PropertyTranslator implements IExperimentPropertyTranslator
{
