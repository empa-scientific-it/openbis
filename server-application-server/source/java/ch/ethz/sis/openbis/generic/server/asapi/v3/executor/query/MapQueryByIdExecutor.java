 ...
 */
@Component
public class MapQueryByIdExecutor extends AbstractMapObjectByIdExecutor<IQueryId, QueryPE> implements IMapQueryByIdExecutor
{
    ...
    @Override
    protected void addListers(IOperationContext context, List<IListObjectById<? extends IQueryId, QueryPE>> listers)
    {
        listers.add(new ListQueryByTechId(queryDAO));
        listers.add(new ListQueryByName(queryDAO));
    }
