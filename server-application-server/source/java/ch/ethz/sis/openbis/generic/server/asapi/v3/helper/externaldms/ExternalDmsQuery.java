...
{
    @Select(sql = "select id, code as identifier from external_data_management_systems where code = any(?{1})", parameterBindings = {
            StringArrayMapper.class }, fetchSize = FETCH_SIZE)
    public List<TechIdStringIdentifierRecord> listExternalDmsTechIdsByPermIds(String[] permIds);
