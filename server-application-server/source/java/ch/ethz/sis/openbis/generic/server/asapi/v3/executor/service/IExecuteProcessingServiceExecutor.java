 ...
 *
 */
public interface IExecuteProcessingServiceExecutor
{

    void execute(IOperationContext context, IDssServiceId serviceId, ProcessingServiceExecutionOptions options);
