 ...
 * @author pkupczyk
 */
public interface ISearchObjectKindModificationExecutor
{

    public List<ObjectKindModification> search(IOperationContext context, ObjectKindModificationSearchCriteria searchCriteria,
