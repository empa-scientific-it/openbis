...
import ch.ethz.sis.openbis.generic.asapi.v3.dto.vocabulary.delete.DeleteVocabulariesOperationResult;
 ...
 */
@Component
public class DeleteVocabulariesOperationExecutor
        extends DeleteObjectsOperationExecutor<IVocabularyId, VocabularyDeletionOptions>
        implements IDeleteVocabulariesOperationExecutor
{

    @Autowired
    private IDeleteVocabularyExecutor executor;

    @Override
    protected Class<? extends DeleteObjectsOperation<IVocabularyId, VocabularyDeletionOptions>> getOperationClass()
    {
        return DeleteVocabulariesOperation.class;
    }

    @Override
    protected DeleteObjectsOperationResult doExecute(IOperationContext context,
            DeleteObjectsOperation<IVocabularyId, VocabularyDeletionOptions> operation)
    {
        executor.delete(context, operation.getObjectIds(), operation.getOptions());
        return new DeleteVocabulariesOperationResult();
    }
