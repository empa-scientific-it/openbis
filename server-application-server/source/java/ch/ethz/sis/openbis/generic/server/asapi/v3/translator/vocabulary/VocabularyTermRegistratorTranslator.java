 ...
 */
@Component
public class VocabularyTermRegistratorTranslator extends ObjectToPersonTranslator implements IVocabularyTermRegistratorTranslator
{
    ...
    protected List<ObjectRelationRecord> loadRecords(LongOpenHashSet objectIds)
    {
        ...
        return query.getTermRegistratorIds(objectIds);
    }
