 ...
 * @author pkupczyk
 */
public class JsonBaseTypeToSubTypesMapping extends JsonReflectionsBaseTypeToSubTypesMapping
{
    public JsonBaseTypeToSubTypesMapping()
    {
        super(new String[] { "ch.ethz.sis" });
    }
}
