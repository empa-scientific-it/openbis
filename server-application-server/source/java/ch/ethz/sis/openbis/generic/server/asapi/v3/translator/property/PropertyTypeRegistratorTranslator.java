 ...
 */
@Component
public class PropertyTypeRegistratorTranslator extends ObjectToOneRelationTranslator<Person, PersonFetchOptions> implements
        IPropertyTypeRegistratorTranslator
{
    ...
    @Override
    protected Map<Long, Person> translateRelated(TranslationContext context, Collection<Long> relatedIds,
            PersonFetchOptions relatedFetchOptions)
    {
