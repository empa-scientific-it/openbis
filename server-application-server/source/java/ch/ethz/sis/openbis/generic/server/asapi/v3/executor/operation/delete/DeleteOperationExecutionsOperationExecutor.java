...
import ch.ethz.sis.openbis.generic.asapi.v3.dto.operation.delete.DeleteOperationExecutionsOperationResult;
 ...
 */
@Component
public class DeleteOperationExecutionsOperationExecutor
        extends DeleteObjectsOperationExecutor<IOperationExecutionId, OperationExecutionDeletionOptions>
        implements IDeleteOperationExecutionsOperationExecutor
{

    @Autowired
    private IDeleteOperationExecutionExecutor executor;

    @Override
    protected Class<? extends DeleteObjectsOperation<IOperationExecutionId, OperationExecutionDeletionOptions>> getOperationClass()
    {
        return DeleteOperationExecutionsOperation.class;
    }

    @Override
    protected DeleteObjectsOperationResult doExecute(IOperationContext context,
            DeleteObjectsOperation<IOperationExecutionId, OperationExecutionDeletionOptions> operation)
    {
        executor.delete(context, operation.getObjectIds(), operation.getOptions());
        return new DeleteOperationExecutionsOperationResult();
    }
