 ...
 */
@Component
public class ProjectLeaderTranslator extends ObjectToPersonTranslator implements IProjectLeaderTranslator
{
    ...
    protected List<ObjectRelationRecord> loadRecords(LongOpenHashSet objectIds)
    {
        ...
        return query.getLeaderIds(new LongOpenHashSet(objectIds));
    }
}
