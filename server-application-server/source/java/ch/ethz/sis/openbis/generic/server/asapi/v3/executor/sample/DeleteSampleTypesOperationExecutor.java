...
import ch.ethz.sis.openbis.generic.asapi.v3.dto.sample.delete.DeleteSampleTypesOperationResult;
 ...
 */
@Component
public class DeleteSampleTypesOperationExecutor extends DeleteObjectsOperationExecutor<IEntityTypeId, SampleTypeDeletionOptions>
        implements IDeleteSampleTypesOperationExecutor
{
    @Autowired
    private IDeleteEntityTypeExecutor executor;

    @Override
    protected Class<? extends DeleteObjectsOperation<IEntityTypeId, SampleTypeDeletionOptions>> getOperationClass()
    {
        return DeleteSampleTypesOperation.class;
    }

    @Override
    protected DeleteObjectsOperationResult doExecute(IOperationContext context,
            DeleteObjectsOperation<IEntityTypeId, SampleTypeDeletionOptions> operation)
    {
        executor.delete(context, operation.getObjectIds(), operation.getOptions());
        return new DeleteSampleTypesOperationResult();
    }
