define([ 'jquery', 'openbis', 'underscore', 'test/dtos' ], function($, defaultOpenbis, _, dtos) {
	...
	var Common = function(assert, openbis) {
		...
		this.Role = dtos.Role;
		this.RoleLevel = dtos.RoleLevel;
		this.DataType = dtos.DataType;
		this.EntityKind = dtos.EntityKind;
		this.DataSetKind = dtos.DataSetKind;
		this.PluginKind = dtos.PluginKind;
		this.PluginType = dtos.PluginType;
		...
		this.ExternalDmsAddressType = dtos.ExternalDmsAddressType;
        ...
        this.EventType = dtos.EventType;
        this.EntityType = dtos.EntityType;
