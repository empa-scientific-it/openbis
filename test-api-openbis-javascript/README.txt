...
* Change the code not only in the original Javascript file but also in the file in targets/gradle/webapps/webapp. 
  ...
  cp -R <root folder>/openbis/source/java/ch/systemsx/cisd/openbis/public/resources/api <root folder>/test-api-openbis-javascript/targets/gradle/webapps/webapp/resources/
