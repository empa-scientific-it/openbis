...
/**
 * A version of the {@link JythonBasedReportingPlugin} with extra support for screening.
 * 
 * @author Chandrasekhar Ramakrishnan
 */
public class ScreeningJythonBasedReportingPlugin extends JythonBasedReportingPlugin
{
     ...
     * @param storeRoot
     */
    public ScreeningJythonBasedReportingPlugin(Properties properties, File storeRoot)
    {
    ...
    {
        super(properties, storeRoot, scriptRunnerFactory, contentProvider);
    }
