...
/**
 * Utility methods for screening resolvers.
 * 
 * @author Kaloyan Enimanev
 */
class ScreeningResolverUtils
{

    public static AnalysisProcedureCriteria extractAnalysisProcedureCriteria(ViewLocator locator)
    {
        String analysisProcedureCode =
                locator.getParameters().get(ScreeningLinkExtractor.ANALYSIS_PROCEDURE_KEY);
