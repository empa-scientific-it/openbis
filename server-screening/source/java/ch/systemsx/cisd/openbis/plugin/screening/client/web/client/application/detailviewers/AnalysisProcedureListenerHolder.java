...
public class AnalysisProcedureListenerHolder
{
    ...
    public IAnalysisProcedureSelectionListener getAnalysisProcedureListener()
    {
        return analysisProcedureListener;
    }

    public void setAnalysisProcedureListener(
            IAnalysisProcedureSelectionListener analysisProcedureListener)
    {
        this.analysisProcedureListener = analysisProcedureListener;
    }
