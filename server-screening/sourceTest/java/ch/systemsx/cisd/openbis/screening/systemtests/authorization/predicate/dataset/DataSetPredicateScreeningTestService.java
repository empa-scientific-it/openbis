 ...
 */
@Component
public class DataSetPredicateScreeningTestService
{

    @Transactional
    @RolesAllowed(value = { RoleWithHierarchy.PROJECT_OBSERVER })
    public void testDataSetReferencePredicate(IAuthSessionProvider session,
            @AuthorizationGuard(guardClass = DatasetReferencePredicate.class) DatasetReference dataSetReference)
    {
    }
